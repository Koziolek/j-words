...
const testCSV = 'pl,romanji,part,hiragana,katakana,kanji,group,pl_info\n' +
    'auto,kuruma,rzeczownik,くるま,,車,,\n' +
    'babcia,sobo,rzeczownik,そぼ,,祖母,,\n' +
    'bank,ginkoo,rzeczownik,ぎんこお,,銀行,,';

const testData = [
    {pl: 'auto', romanji: 'kuruma', part: 'rzeczownik', hiragana: 'くるま', katakana: '', kanji: '車', group: '', pl_info: ''},
    {pl: 'babcia', romanji: 'sobo', part: 'rzeczownik', hiragana: 'そぼ', katakana: '', kanji: '祖母', group: '', pl_info: ''},
    {pl: 'bank', romanji: 'ginkoo', part: 'rzeczownik', hiragana: 'ぎんこお', katakana: '', kanji: '銀行', group: '', pl_info: ''}
];
const loadedWords = [
    {pl: 'auto', words: [{pl: 'auto', romanji: 'kuruma', part: 'rzeczownik', hiragana: 'くるま', katakana: '', kanji: '車', group: '', pl_info: ''}]},
    {
        pl: 'babcia',
        words: [{pl: 'babcia', romanji: 'sobo', part: 'rzeczownik', hiragana: 'そぼ', katakana: '', kanji: '祖母', group: '', pl_info: ''}]
    },
    {
        pl: 'bank',
        words: [{pl: 'bank', romanji: 'ginkoo', part: 'rzeczownik', hiragana: 'ぎんこお', katakana: '', kanji: '銀行', group: '', pl_info: ''}]
    }
];
describe('State transformer', () => {
    ...
    test('Should setup state based on bad answers', () => {
        ...
        const currentState = {
            ...
            word: testData[2],
            goodWords: [],
            badWords: [{...testData[0], answer: 'くる'}, {...testData[1], answer: 'くる'}],
            mode: false
        };
        const expectedState = {
            counter: {
...
describe('Component UI', () => {
    ...
    test('Load and learning', async () => {
        ...
        const wordService = require('../words/WordsService');
        ...
        const titleElement = screen.getByText(/Nauka – 3 losowych słów/i);
        expect(titleElement).toBeInTheDocument();
