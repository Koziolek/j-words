...
test('Should group worlds by pl', () => {
    ...
    const words = [
        {pl: 'długopis', romanji: 'boorupen', part: 'rzeczownik', hiragana: '', katakana: 'ボオルペン', kanji: '', group: '', pl_info: ''},
        {pl: 'długopis', romanji: 'pen', part: 'rzeczownik', hiragana: '', katakana: 'ペン', kanji: '', group: '', pl_info: ''},
